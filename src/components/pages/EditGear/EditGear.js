    ...
    smashData.getGearWithProperties(editId)
      .then((fbResponse) => {
        ...
        this.setState({
          ...
          gearPartyList: currentGear.selctedParties,
        });
      })
